...
<div className="flex flex-col py-16 m-auto bg-white p-auto ">
                        ...
                        {nftData.map((item, index) => {
                            return (
                                <div className="inline-block px-3" key={index}>
                                    <div
                                        className="w-64 h-64 max-w-xs overflow-hidden transition-shadow duration-300 ease-in-out bg-white rounded-lg shadow-md hover:shadow-xl"
                                    >
